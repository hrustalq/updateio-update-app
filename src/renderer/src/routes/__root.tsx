...
import { PageNavigation } from '@renderer/components/page-navigation'
...
export const Root: FC<ComponentProps<'div'>> = () => {
  ...
  return (
    <>
      <RootHeader />
      <div className="min-h-[calc(100vh-20rem)] container mx-auto max-w-screen-2xl p-4 md:p-5 flex flex-col">
        <Outlet />
        <Toaster />
      </div>
      <PageNavigation />
